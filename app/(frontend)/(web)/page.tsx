  ...
  return (
    <main className="prose prose-stone dark:prose-invert max-w-none">
      ...
      <section className="container mt-12">
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              <Button
                onClick={() =>
                  toast('Default Toast', { description: 'default' })
                }
                variant="default"
              >
                default
              ...
              <Button
                onClick={() =>
                  toast.info('Info Toast', { description: 'info' })
                }
                variant="info"
              >
                info
                  ...
                  <div>
                    {[
                      ...
                      <div
                        ...
                        // biome-ignore lint/suspicious/noArrayIndexKey: static array, no problem
                        key={index}
                      >
        ...
        {/** biome-ignore lint/a11y/useValidAnchor: this is a template */}
